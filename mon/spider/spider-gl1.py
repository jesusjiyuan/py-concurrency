...
class test:
    ...
    browser.get('https://www.yadea.com.cn/')
...
test = test()
text_cont = test.browser.find_element(By.TAG_NAME,"span").text
if "骑行产品" == text_cont:
    test.browser.find_element(By.TAG_NAME,"span").click()
    test.browser.find_element(By.CSS_SELECTOR,"text=VFLY| >> div").click()
    test.browser